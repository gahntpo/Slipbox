...
This is the project that I created for a online course on SwiftUI for macOS with a Core Data backend. The course can be found here
https://www.udemy.com/course/swiftui-built-a-real-world-application-using-core-data/?referralCode=A909B32DE438B3BE9A9A
